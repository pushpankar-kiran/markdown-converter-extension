...
- Trolling, or other conduct which could reasonably be considered inappropriate

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the project maintainer through the repository's **Security** tab
(private vulnerability reporting) or by opening a confidential channel via the
